...
public class FirstSetupObj {
    ...
    List<SubServicesObj> subServicesList = new ArrayList<>();
    ...
    public List<SubServicesObj> getSubServicesList() {
        return subServicesList;
    }

    public void setSubServicesList(List<SubServicesObj> subServicesList) {
