...
public class DashboardObj implements Serializable {
    ...
    public DashboardObj(int ID, String tvNameSevice, String tvDate, String tvTimeStart, String tvNameStaff, String tvDuration) {
        super();
        this.ID = ID;
        this.tvNameSevice = tvNameSevice;
        this.tvDate =tvDate;
