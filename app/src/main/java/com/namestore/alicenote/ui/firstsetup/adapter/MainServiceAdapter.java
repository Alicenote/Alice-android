...
public class MainServiceAdapter extends BaseAdapter {
    ...
    ArrayList<MainServicesObj> mainServices = new ArrayList<MainServicesObj>();
    LayoutInflater inflater;
    Context context;

    public MainServiceAdapter(Context context, ArrayList<MainServicesObj> myList) {
    ...
    @Override
    public MainServicesObj getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MainServicesObj currentListData = getItem(position);
