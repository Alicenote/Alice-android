...
public class DashboardCustomRecyclerViewAdapter extends
    ...
    Context context;
    private List<DashboardObj> Dashboard_Object = new ArrayList<DashboardObj>();

    public DashboardCustomRecyclerViewAdapter(Context context, List<DashboardObj> listData) {
        this.Dashboard_Object = listData;
        this.context =context;
    }

    public void updateList(List<DashboardObj> data) {
